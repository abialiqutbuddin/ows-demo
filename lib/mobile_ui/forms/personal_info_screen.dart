          ...
          Obx(() => Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: controller.isButtonEnabled.value ? Colors.brown : Colors.grey,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            spacing: 8,
            children: [
              Flexible(child: _buildField("Mobile No.", controller.mobileNo)),
              Flexible(child: _buildField("WhatsApp No.", controller.whatsappNo)),
            ],
          ),
          _buildField("Email", controller.email),
          _buildField("Residential Address", controller.residentialAddress, height: 120),
        ],
      ),
    );
  }
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildField("Relation to Student", controller.relationToStudent),
                ],
              )),
        ],
      ),
