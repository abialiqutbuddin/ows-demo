      ...
      body: ListView(
        children: [
          _buildCollapsibleSection(
              "Personal Information", isPersonalExpanded, personalInfo,
              complete: controller.isPersonalInfoComplete),
          _buildCollapsibleSection(
              "Student Info", isStudentExpanded, studentInfo,
              complete: controller.isStudentInfoComplete),
          _buildCollapsibleSection("Family Info", isFamilyExpanded, familyInfo,
              complete: controller.isFamilyInfoComplete),
          Obx(() => Padding(
        ...
        children: [
          ...
          _buildDropdown(
            ...
            onChanged: (value) {
              ...
              controller.mohallaName.value = controller.mohalla.firstWhere(
                  (e) => e["id"] == controller.selectedMohalla.value)["name"];
            },
            isEnabled: true,
          ),
          _buildField("Family Surname", controller.familySurname,
              function: () => controller.validatePersonalInfoFields()),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          _buildField("Full Name", controller.fullName,
              function: () => controller.validateStudentInfoFields()),
          _buildField("CNIC", controller.cnic,
              function: () => controller.validateStudentInfoFields()),
          _buildField("Date of Birth", controller.dateOfBirth,
              function: () => controller.validateStudentInfoFields()),
          Row(
            spacing: 8,
            children: [
              Flexible(
                  child: _buildField("Mobile No.", controller.mobileNo,
                      function: () => controller.validateStudentInfoFields())),
              Flexible(
                  child: _buildField("WhatsApp No.", controller.whatsappNo,
                      function: () => controller.validateStudentInfoFields())),
            ],
          ),
          _buildField("Email", controller.email,
              function: () => controller.validateStudentInfoFields()),
          _buildField("Residential Address", controller.residentialAddress,
              height: 120,
              function: () => controller.validateStudentInfoFields()),
        ],
      ),
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildField("Name", controller.fatherName,
                      function: () => controller.validateFamilyInfoFields()),
                  _buildField("CNIC", controller.fatherCnic,
                      function: () => controller.validateFamilyInfoFields()),
                  Container(
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildField("Name", controller.motherName,
                      function: () => controller.validateFamilyInfoFields()),
                  _buildField("CNIC", controller.motherCnic,
                      function: () => controller.validateFamilyInfoFields()),
                  Container(
                    width: double.infinity,
                    height: 150,
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildField("Name", controller.guardianName,
                      function: () => controller.validateFamilyInfoFields()),
                  _buildField("CNIC", controller.guardianCnic,
                      function: () => controller.validateFamilyInfoFields()),
                  _buildField(
                      "Relation to Student", controller.relationToStudent,
                      function: () => controller.validateFamilyInfoFields()),
                ],
              )),
        ],
